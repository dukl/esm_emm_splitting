  ...
  protocol_configuration_options_t * pco)
{
 ...
 // else if ((*esm_ctx[0]).n_active_ebrs > BEARERS_PER_UE) {
 ...
 // obj_hashtable_insert(mme_app_desc.mme_ue_contexts.guti_ue_context_htbl,&emm_context->_guti,sizeof(guti_t),esm_ctx);
